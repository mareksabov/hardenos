...
`Mod` = `Alt` (= `Option`/⌥ na Macu pri UTM). macOS preberá Cmd/⌘ skratky — napr.
Cmd+Shift+Q = Odhlásiť sa — skôr než VM, kým Alt sa do VM dostane vždy a nezatieni
browser Ctrl+T/Ctrl+1-4 ani tmux Ctrl+B. Lišta je inak skrytá a **odkryje sa pri
myši na hornom okraji** (auto-hide cez [waycorner](https://github.com/edzdez/waycorner)).
